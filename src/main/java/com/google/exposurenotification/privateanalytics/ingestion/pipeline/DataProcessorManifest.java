...
public class DataProcessorManifest {
  ...
  private void init() {
    try {
      ...
      throw new ManifestProcessingRuntimeException("Unable to fetch and parse manifest", e);
    }
  }
  ...
  protected class ManifestProcessingRuntimeException extends RuntimeException {

    public ManifestProcessingRuntimeException(String message, Throwable cause) {
      super(message, cause);
    }
  }
}
