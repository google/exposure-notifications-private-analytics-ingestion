...
public class SerializePacketHeaderSignature extends
    ...
    public void processElement(ProcessContext c) {
        ...
        String phaFilePath =
                phaPrefix + batchId.toString() + "_metric=" + metadata.getMetricName();
        ...
        //TODO pass the UUID for the full batch and not this file
        serializePacketHeaderAndSig(startTime, duration, metadata, batchId, facilitatorPath, facilitatorPackets);
    }
